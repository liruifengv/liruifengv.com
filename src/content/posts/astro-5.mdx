...
Astro 是用于内容驱动网站的最佳框架，通过 Astro 5.0 我们使其更加强大。**Astro Content Layer** 是一种新的灵活且可插拔的方式来管理内容，提供了一个统一的、类型安全的 API 来定义、加载和访问你的内容，无论它来自何处。
...
- 定义你自己的 loader，[只需几行代码](https://docs.astro.build/en/guides/content-collections/#building-a-custom-loader) 就可以从任何 API 获取内容。
...
![](../../assets/images/astro-5/content-layer-architecture.webp)
...
![A diagram showing the server island population parts of the page from the server.](../../assets/images/astro-5/server-islands-diag.webp)
