...
- 使用数量不断增加的 [社区构建和第三方 loader](https://astro.build/integrations/?search=&categories%5B%5D=loaders) 从流行的来源获取内容，如 [Storyblok](https://astro.build/blog/storyblok-loader/)、[Cloudinary](https://astro.build/blog/cloudinary-loader/) 或 [Hygraph](https://astro.build/blog/hygraph-loader/)。
